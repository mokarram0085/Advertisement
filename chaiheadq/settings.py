...
SECRET_KEY = 'django-insecure-^4nk8h(fqc-8&cwp)1^-+ncoc@4wiilpjypg!=q%7-db_*s-8b'
...
MEDIA_URL = '/media/' #URL used to access uploaded files through browser
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  #Actual directory on the server where uploaded files are saved


# my doubt next 2 lines beacause here we dont't use static files 
